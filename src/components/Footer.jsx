    ...
    return (
        <footer className='bg-black lg:rounded-2xl p-6 lg:p-8 lg:m-2 flex flex-col gap-10 lg:gap-[150px] '>
            ...
            <div className='text-left lg:text-center'>
                <p className='text-h2-sm md:text-h2-md lg:text-h2 text-white_60'>Your brand deserves better. </p>
                <p className='text-h2-sm md:text-h2-md lg:text-h2 text-white'>Let’s build it right.</p>
            </div>
            ...
            <div className='flex flex-col lg:flex-row justify-between lg:items-end gap-10'>
                <div className='flex justify-between lg:gap-40 items-end order-3 lg:order-1'>
                    <div>
                        <Link to={'/'}><span className='logo_white'>2zup</span></Link>
                ...
                <div className='order-1 lg:order-3'>
                    ...
                    <p className='text-h4-md lg:text-h4 text-white'>hello@yourstudio.com</p>
                </div>

                <div className='order-2 lg:order-1'>
                    <p className='text-body text-white_60'>Phone</p>
                    <p className='text-h4-md lg:text-h4 text-white'>+1 (555) 123-4567</p>
                </div>
            </div>
        </footer>)
}
